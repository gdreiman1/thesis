...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 14 11:28:22 2019
...
for AID, activity_table in AID_dict.items():        
    current_scorer = Scorer(activity_table,3,20)
    ...
    for classifier_name, classifier in classifier_dict.items():
        if classifier_name != 'RF':
            ...
            def objective(**params):
                ...
                return score
            opt_res = gp_minimize(objective, space, n_calls=30,n_random_starts = 10, verbose=1)
            opt_results_list.append({'AID':AID,'Classifier':classifier_name,'opt_res':opt_res})
    
opt_df = pd.DataFrame(opt_results_list)
dump_path ='/home/gabriel/Dropbox/UCL/Thesis/Data/hypertune_SVM_LGBM3.csv'
