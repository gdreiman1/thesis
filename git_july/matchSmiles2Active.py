...
@author: gdrei
"""
'''Creating files that have smiles and activity strings attached to eachother'''
...
for AID in ['AID_1345083','AID_624255','AID_449739','AID_995','AID_938','AID_628','AID_605','AID_596','AID_893','AID_894']:
    ...
    prop_dict_list = [{'PUBCHEM_COMPOUND_CID':mol.GetProp('PUBCHEM_COMPOUND_CID'),'PUBCHEM_OPENEYE_CAN_SMILES':mol.GetProp('PUBCHEM_OPENEYE_CAN_SMILES')} for mol in suppl]
    #turn into df
