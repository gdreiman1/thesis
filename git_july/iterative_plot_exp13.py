...
first8 = 'tuned_3_svmmod0.pkl'
second8 = 'tuned_3_svmmod1.pkl'
third8 = 'tuned_3_svmmod2.pkl'
...
plot_avg_percent_found(pd.concat([expr_1,expr_2,expr_3]),'Mean Active Recovery for Exp_3',10,5)
for exper in [expr_1,expr_2,expr_3]:
