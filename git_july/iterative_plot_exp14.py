...
first8 = 'tuned_4_svmmod0.pkl'
second8 = 'tuned_4_svmmod1.pkl'
third8 = 'tuned_4_svmmod2.pkl'
...
plot_avg_percent_found(pd.concat([expr_1,expr_2,expr_3]),'Mean Active Recovery for Exp_4',15,10)
for exper in [expr_1,expr_2,expr_3]:
